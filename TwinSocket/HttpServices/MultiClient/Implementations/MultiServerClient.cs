...
namespace RelayProtection.Services.HttpServices.MultiClient.Implementations
{
    public class MultiServerClient<T> : IAsyncDisposable
    {
        ...
        public INotificationEvents<T> NotificationEvents { get; }

        public MultiServerClient(
            LaptopServerOptions laptopServerOptions,
            INotificationEvents<T> notificationEvents,
        ...
        public async Task ConnectToServerAsync()
        {
            ...
            try
            {
                ...
                NotificationEvents.NotifyServerConnected(_laptopServerOptions.ServerAddress);
        ...
        public async Task DisconnectServerAsync()
        {
            if (_webSocket != null)
            {
                ...
                NotificationEvents.NotifyServerDisconnected(_laptopServerOptions.ServerAddress);
            }
        }
